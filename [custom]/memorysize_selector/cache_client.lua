...
addCommandHandler("cachesize", function()
    ...
    if isElement(selectorWindow) then
        ...
        -- Add new options
        guiComboBoxAddItem(memoryComboBox, "4 MiB (Default)")
        guiComboBoxAddItem(memoryComboBox, "8 MiB")
        guiComboBoxAddItem(memoryComboBox, "16 MiB")
        guiComboBoxAddItem(memoryComboBox, "32 MiB")
        guiComboBoxAddItem(memoryComboBox, "64 MiB")
